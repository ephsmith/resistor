...
class Resistor:
    ...
    Properties:
        ...
        code - a tuple of colors representing the resistance. Ex. (brown, black, red, gold)
    ...
    _colors = ['black', 'brown','red', 'orange','yellow','green','blue','purple','gray','white']

    _tolerance_code = {0.1: 'silver', 0.05: 'gold', 'silver': 0.1, 'gold': 0.05}
    ...
    def ten_pct_standards(self):
        return _ten_pct_standards

    @property
    def five_pct_standards(self):
        return _five_pct_standards
    ...
    def code(self,code):
        if type(code) is not tuple:
            raise TypeError('code must be a tuple: ex. ("red","red","red","gold")')
